...
/* Module Version: 4.6 */
/* C:\lscc\diamond\3.10_x64\ispfpga\bin\nt64\scuba.exe -w -n count32 -lang verilog -synth lse -bus_exp 7 -bb -arch xo3c00f -type counter -up -width 32 -cnt_low 0 -cnt_up 4294967295  */
/* Fri May 25 18:32:25 2018 */


`timescale 1 ns / 1 ps
module count32 (Clock, Clk_En, Aclr, Q)/* synthesis NGD_DRC_MASK=1 */;
    input wire Clock;
    input wire Clk_En;
    input wire Aclr;
    output wire [31:0] Q;
